...
namespace OSADY
{
    public partial class P_GestionContratoRH : Form
    {
        public P_GestionContratoRH()
        {
            InitializeComponent();
        }
        ...
        {
            P_MenuRecursosHumanos Nuevo = new P_MenuRecursosHumanos();
            Nuevo.Show();
            this.Hide();
        }
        ...
        private void btn1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                int res_c = Instancia_Verificar.Encamsulamiento_ConsultaPrevia_Contrato(cod_empleado);
                if (res_c != 1)
                {
